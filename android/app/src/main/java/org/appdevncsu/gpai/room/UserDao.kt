...
interface UserDao {
    ...
    @Query("INSERT INTO users (id, name, email, photoURL, token) VALUES (:id, :name, :email, :photoURL, :token) ON CONFLICT DO UPDATE SET id = :id, name = :name, email = :email, token = :token")
