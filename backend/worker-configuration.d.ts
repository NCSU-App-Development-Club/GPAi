/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b1dd256ff9305133b36c02ed125451e2)
// Runtime types generated with workerd@1.20260828.1 2025-06-17 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	RATE_LIMITER_MIN: RateLimit;
	EXPECTED_HD_DOMAIN: "ncsu.edu";
	SESSION_TTL: "2592000";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXPECTED_HD_DOMAIN" | "SESSION_TTL" | "GOOGLE_ANDROID_CLIENT_ID" | "GOOGLE_WEB_CLIENT_ID" | "AI_GATEWAY_ACCOUNT_ID" | "AI_GATEWAY_ID" | "AI_GATEWAY_TOKEN" | "AI_GATEWAY_MODEL" | "MESSAGE_SIGNING_SECRET">> {}
}
